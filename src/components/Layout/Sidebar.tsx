  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="text-xs text-gray-500">({customerCount})</span>
      </Button>
        ...
        <div className="space-y-1">
          ...
          {departmentsList.some(dept => dept.code === 'all') && (
            ...
            >
              ...
              <span className="flex-1 text-left">所有客戶</span>
              <span className="text-xs text-gray-500">({customerCounts['all'] || 0})</span>
            </Button>
          )}
          ...
          {departmentsList.some(dept => dept.code === 'uncategorized') && (
            ...
            >
              ...
              <span className="flex-1 text-left">未分類</span>
              <span className="text-xs text-gray-500">({customerCounts['uncategorized'] || 0})</span>
            </Button>
          )}
        </div>
